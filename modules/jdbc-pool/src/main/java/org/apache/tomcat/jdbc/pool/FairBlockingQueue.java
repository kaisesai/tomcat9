...
public class FairBlockingQueue<E> implements BlockingQueue<E> {
   ...
   */
  static final boolean isLinux = "Linux".equals(System.getProperty("os.name")) && (!Boolean
    .getBoolean(FairBlockingQueue.class.getName() + ".ignoreOS"));
  ...
  protected class ItemFuture<T> implements Future<T> {
    ...
    public T get() throws InterruptedException, ExecutionException {
      if (item != null) {
        ...
        throw new ExecutionException("ItemFuture incorrectly instantiated. Bug in the code?",
                                     new Exception());
      }
    }
