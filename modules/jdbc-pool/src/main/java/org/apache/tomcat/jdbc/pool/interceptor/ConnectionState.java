...
public class ConnectionState extends JdbcInterceptor {
  ...
  public void reset(ConnectionPool parent, PooledConnection con) {
    ...
    if (poolProperties.getDefaultTransactionIsolation()
      ...
      try {
        if (transactionIsolation == null || transactionIsolation.intValue() != poolProperties
          .getDefaultTransactionIsolation()) {
          con.getConnection()
            .setTransactionIsolation(poolProperties.getDefaultTransactionIsolation());
    ...
    if (poolProperties.getDefaultReadOnly() != null) {
      try {
        if (readOnly == null || readOnly.booleanValue() != poolProperties.getDefaultReadOnly()
          .booleanValue()) {
    ...
    if (poolProperties.getDefaultAutoCommit() != null) {
      try {
        if (autoCommit == null || autoCommit.booleanValue() != poolProperties.getDefaultAutoCommit()
          .booleanValue()) {
