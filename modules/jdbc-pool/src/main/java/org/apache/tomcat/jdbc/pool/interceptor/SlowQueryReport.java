...
public class SlowQueryReport extends AbstractQueryReport {
   ...
   */
  protected static final ConcurrentHashMap<String, ConcurrentHashMap<String, QueryStats>>
    perPoolStats = new ConcurrentHashMap<>();
  ...
  @Override
  protected String reportFailedQuery(String query, Object[] args, String name, long start,
                                     Throwable t) {
  ...
  @Override
  protected String reportQuery(String query, Object[] args, final String name, long start,
                               long delta) {
  ...
  public static class QueryStats {
    ...
    static final String[] FIELD_NAMES = new String[] {"query", "nrOfInvocations",
      "maxInvocationTime", "maxInvocationDate", "minInvocationTime", "minInvocationDate",
      "totalInvocationTime", "failures", "prepareCount", "prepareTime", "lastInvocation"};
    
    static final String[] FIELD_DESCRIPTIONS = new String[] {"The SQL query",
    ...
    static final OpenType<?>[] FIELD_TYPES = new OpenType[] {SimpleType.STRING, SimpleType.INTEGER,
      SimpleType.LONG, SimpleType.LONG, SimpleType.LONG, SimpleType.LONG, SimpleType.LONG,
      SimpleType.LONG, SimpleType.INTEGER, SimpleType.LONG, SimpleType.LONG};
    ...
    public CompositeDataSupport getCompositeData(final CompositeType type)
      ...
      Object[] values = new Object[] {query, Integer.valueOf(nrOfInvocations),
        ...
        Long.valueOf(minInvocationTime), Long.valueOf(minInvocationDate),
        Long.valueOf(totalInvocationTime), Long.valueOf(failures), Integer.valueOf(prepareCount),
        Long.valueOf(prepareTime), Long.valueOf(lastInvocation)};
