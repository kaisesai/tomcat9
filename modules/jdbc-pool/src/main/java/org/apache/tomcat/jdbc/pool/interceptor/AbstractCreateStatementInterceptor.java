...
public abstract class AbstractCreateStatementInterceptor extends JdbcInterceptor {
  ...
  protected static final String[] STATEMENT_TYPES = {CREATE_STATEMENT, PREPARE_STATEMENT,
    PREPARE_CALL};
  ...
  protected static final String[] EXECUTE_TYPES = {EXECUTE, EXECUTE_QUERY, EXECUTE_UPDATE,
    EXECUTE_BATCH};
  ...
  protected Constructor<?> getConstructor(int idx, Class<?> clazz) throws NoSuchMethodException {
    if (constructors[idx] == null) {
      Class<?> proxyClass = Proxy
        .getProxyClass(AbstractCreateStatementInterceptor.class.getClassLoader(),
                       new Class[] {clazz});
   ...
   */
  public abstract Object createStatement(Object proxy, Method method, Object[] args,
