...
public class DataSourceProxy implements PoolConfiguration {
   ...
   * @throws SQLException Connection error
   */
  public javax.sql.PooledConnection getPooledConnection(String username, String password)
    throws SQLException {
    return (javax.sql.PooledConnection) getConnection();
  }
  ...
  public void setPassword(String password) {
    ...
    this.poolProperties.getDbProperties()
      .setProperty("password", this.poolProperties.getPassword());
  }
