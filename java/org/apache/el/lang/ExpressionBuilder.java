...
public final class ExpressionBuilder implements NodeVisitor {
  ...
  private static final ConcurrentCache<String, Node> expressionCache = new ConcurrentCache<>(
    CACHE_SIZE);
  ...
  public void visit(Node node) throws ELException {
    if (node instanceof AstFunction) {
      ...
      if (m.isVarArgs() && inputParameterCount < methodParameterCount - 1
        ...
        throw new ELException(MessageFactory
                                .get("error.fnMapper.paramcount", funcNode.getOutputName(),
  ...
  public MethodExpression createMethodExpression(Class<?> expectedReturnType,
    ...
    if (n instanceof AstValue || n instanceof AstIdentifier) {
      return new MethodExpressionImpl(expression, n, this.fnMapper, this.varMapper,
