...
public final class AstValue extends SimpleNode {
  ...
  public Class<?> getType(EvaluationContext ctx) throws ELException {
    ...
    if (!ctx.isPropertyResolved()) {
      throw new PropertyNotFoundException(
        MessageFactory.get("error.resolver.unhandled", t.base, t.property));
    }
    return result;
  }
  ...
  private final Target getTarget(EvaluationContext ctx) throws ELException {
    ...
    while (i < propCount) {
      if (i + 2 < propCount && this.children[i + 1] instanceof AstMethodParameters) {
        ...
        if (property == null) {
          throw new PropertyNotFoundException(
            MessageFactory.get("error.unreachable.property", property));
        }
  ...
  public Object getValue(EvaluationContext ctx) throws ELException {
    ...
    if (!ctx.isPropertyResolved()) {
      throw new PropertyNotFoundException(
        MessageFactory.get("error.resolver.unhandled", base, suffix));
    }
    return base;
  }
  ...
  public Object invoke(EvaluationContext ctx, @SuppressWarnings("rawtypes") Class[] paramTypes,
    ...
    if (isParametersProvided()) {
      values = ((AstMethodParameters) this.jjtGetChild(this.jjtGetNumChildren() - 1))
        .getParameters(ctx);
  ...
  private Object[] convertArgs(EvaluationContext ctx, Object[] src, Method m) {
    ...
    if (m.isVarArgs() && paramCount > 1 && (src == null || paramCount > src.length)
      ...
      if (m.isVarArgs()) {
        msg = MessageFactory
          .get("error.invoke.tooFewParams", m.getName(), srcCount, Integer.toString(paramCount));
      } else {
        msg = MessageFactory
          .get("error.invoke.wrongParams", m.getName(), srcCount, Integer.toString(paramCount));
      }
    ...
    if (m.isVarArgs()) {
      ...
      dest[paramCount - 1] = ELSupport
        .coerceToType(ctx, src[paramCount - 1], types[paramCount - 1]);
    }
