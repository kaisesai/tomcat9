...
public class CredentialHandlerRuleSet implements RuleSet {
  ...
  private static final int MAX_NESTED_LEVELS = Integer
    .getInteger("org.apache.catalina.startup.CredentialHandlerRuleSet.MAX_NESTED_LEVELS", 3)
    .intValue();
  ...
  public void addRuleInstances(Digester digester) {
    ...
    for (int i = 0; i < MAX_NESTED_LEVELS; i++) {
      ...
      addRuleInstances(digester, pattern.toString(),
                       i == 0 ? "setCredentialHandler" : "addCredentialHandler");
    }
  }
