...
public final class SecurityUtil {
   ...
   */
  public static void doAsPrivilege(final String methodName, final Servlet targetObject,
                                   final Class<?>[] targetType, final Object[] targetArguments)
    throws Exception {
  ...
  public static void doAsPrivilege(final String methodName, final Servlet targetObject,
    ...
    if (methodsCache == null) {
      ...
      if (method == null) {
        method = createMethodAndCacheIt(methodsCache, Servlet.class, methodName,
  ...
  public static void doAsPrivilege(final String methodName, final Filter targetObject,
    ...
    if (methodsCache == null) {
      ...
      method = findMethod(methodsCache, methodName);
      if (method == null) {
        method = createMethodAndCacheIt(methodsCache, Filter.class, methodName,
                                        targetParameterTypes);
      }
    }
