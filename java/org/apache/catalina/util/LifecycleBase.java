...
public abstract class LifecycleBase implements Lifecycle {
  ...
  public final synchronized void destroy() throws LifecycleException {
    ...
    if (!state.equals(LifecycleState.STOPPED) && !state.equals(LifecycleState.FAILED) && !state
      .equals(LifecycleState.NEW) && !state.equals(LifecycleState.INITIALIZED)) {
  ...
  private synchronized void setStateInternal(LifecycleState state, Object data, boolean check)
    ...
    if (check) {
      ...
      if (!(state == LifecycleState.FAILED || (this.state == LifecycleState.STARTING_PREP
        && state == LifecycleState.STARTING) || (this.state == LifecycleState.STOPPING_PREP
        && state == LifecycleState.STOPPING) || (this.state == LifecycleState.FAILED
