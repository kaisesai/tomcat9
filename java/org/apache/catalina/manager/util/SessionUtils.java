...
public class SessionUtils {
   ...
   */
  private static final String[] LOCALE_TEST_ATTRIBUTES = new String[] {STRUTS_LOCALE_KEY,
    SPRING_LOCALE_KEY, JSTL_LOCALE_KEY, "Locale", "java.util.Locale"};
   ...
   */
  private static final String[] USER_TEST_ATTRIBUTES = new String[] {"Login", "User", "userName",
    "UserName", "Utilisateur", "SPRING_SECURITY_LAST_USERNAME"};
  ...
  public static Locale guessLocaleFromSession(final HttpSession in_session) {
    ...
    try {
      ...
      for (Enumeration<String> enumeration = in_session.getAttributeNames();
           enumeration.hasMoreElements(); ) {
        String name = enumeration.nextElement();
        if (name.contains("tapestry") && name.contains("engine") && null != in_session
  ...
  public static Object guessUserFromSession(final Session in_session) {
    ...
    try {
      ...
      for (Enumeration<String> enumeration = httpSession.getAttributeNames();
           enumeration.hasMoreElements(); ) {
        String name = enumeration.nextElement();
