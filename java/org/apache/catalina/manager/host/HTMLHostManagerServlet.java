...
public final class HTMLHostManagerServlet extends HostManagerServlet {
  ...
  public void list(HttpServletRequest request, HttpServletResponse response, String message,
    ...
    // HTML Header Section
    writer
      .print(MessageFormat.format(org.apache.catalina.manager.Constants.HTML_HEADER_SECTION, args));
    
    // Body Header Section
    writer
      .print(MessageFormat.format(org.apache.catalina.manager.Constants.BODY_HEADER_SECTION, args));
