...
public class SSIEcho implements SSICommand {
  ...
  protected boolean isValidEncoding(String encoding) {
    return encoding.equalsIgnoreCase(SSIMediator.ENCODING_URL) || encoding
      .equalsIgnoreCase(SSIMediator.ENCODING_ENTITY) || encoding
      .equalsIgnoreCase(SSIMediator.ENCODING_NONE);
  }
