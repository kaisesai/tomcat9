...
public class SSIServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    isVirtualWebappRelative = Boolean
      .parseBoolean(getServletConfig().getInitParameter("isVirtualWebappRelative"));
  ...
  protected void requestHandler(HttpServletRequest req, HttpServletResponse res)
    ...
    if (path == null || path.toUpperCase(Locale.ENGLISH).startsWith("/WEB-INF") || path
  ...
  protected void processSSI(HttpServletRequest req, HttpServletResponse res, URL resource)
    throws IOException {
    SSIExternalResolver ssiExternalResolver = new SSIServletExternalResolver(getServletContext(),
                                                                             req, res,
    ...
    long lastModified = ssiProcessor
      .process(bufferedReader, resourceInfo.getLastModified(), printWriter);
    if (lastModified > 0) {
