...
public final class CGIServlet extends HttpServlet {
   ...
   */
  private Pattern cmdLineArgumentsEncodedPattern = Pattern
    .compile("[a-zA-Z0-9\\Q%;/?:@&,$-_.!~*'()\\E]+");
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    if (getServletConfig().getInitParameter("cmdLineArgumentsEncoded") != null) {
      cmdLineArgumentsEncodedPattern = Pattern
        .compile(getServletConfig().getInitParameter("cmdLineArgumentsEncoded"));
    }
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    if (cgiEnv.isValid()) {
      CGIRunner cgi = new CGIRunner(cgiEnv.getCommand(), cgiEnv.getEnvironment(),
  ...
  protected class CGIEnvironment {
      ...
      if (enableCmdLineArguments && (req.getMethod().equals("GET") || req.getMethod().equals("POST")
        ...
        if (qs != null && qs.indexOf('=') == -1) {
          ...
          while (qsTokens.hasMoreTokens()) {
            ...
            if (cmdLineArgumentsDecodedPattern != null && !cmdLineArgumentsDecodedPattern
              .matcher(decodedArgument).matches()) {
              if (log.isDebugEnabled()) {
     ...
     * </ul>
     */
    protected String[] findCGI(String pathInfo, String webAppRootDir, String contextPath,
                               String servletPath, String cgiPathPrefix) {
      String path = null;
      String name = null;
      String scriptname = null;
      
      if (webAppRootDir != null && webAppRootDir.lastIndexOf(File.separator) == (
    ...
    protected boolean setCGIEnvironment(HttpServletRequest req) throws IOException {
      ...
      if (sCGIFullPath == null || sCGIScriptName == null || sCGIFullName == null
        || sCGIName == null) {
        return false;
      }
  ...
  protected class CGIRunner {
     ...
     */
    protected CGIRunner(String command, Hashtable<String, String> env, File wd,
    ...
    protected void run() throws IOException {
      ...
      if ((command.contains(File.separator + "." + File.separator)) || (command
        .contains(File.separator + "..")) || (command.contains(".." + File.separator))) {
