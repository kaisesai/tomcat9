 ...
 */
public class McastService extends MembershipServiceBase
   ...
   */
  @Override
  public void setLocalMemberProperties(String listenHost, int listenPort, int securePort,
                                       int udpPort) {
  ...
  public void start(int level) throws java.lang.Exception {
    ...
    impl = new McastServiceImpl(localMember,
                                ...
                                java.net.InetAddress
                                  .getByName(properties.getProperty("mcastAddress")), ttl,
                                soTimeout, this, this, Boolean
                                  .parseBoolean(properties.getProperty("localLoopbackDisabled")));
  ...
  public void broadcast(ChannelMessage message) throws ChannelException {
    ...
    if (data.length > McastServiceImpl.MAX_PACKET_SIZE) {
      throw new ChannelException(
        sm.getString("mcastService.exceed.maxPacketSize", Integer.toString(data.length),
