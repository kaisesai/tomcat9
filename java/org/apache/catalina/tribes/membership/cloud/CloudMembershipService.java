...
public class CloudMembershipService extends MembershipServiceBase
  ...
  public void start(int level) throws Exception {
    ...
    if (membershipProvider == null) {
      ...
      membershipProvider = (MembershipProvider) Class.forName(provider).getConstructor()
        .newInstance();
  ...
  public Member getLocalMember(boolean incAliveTime) {
    if (incAliveTime && localMember != null) {
      localMember
        .setMemberAliveTime(System.currentTimeMillis() - localMember.getServiceStartTime());
    }
    return localMember;
  }
