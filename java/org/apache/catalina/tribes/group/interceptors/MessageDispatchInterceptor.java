...
public class MessageDispatchInterceptor extends ChannelInterceptorBase
  ...
  protected static final StringManager sm = StringManager
    .getManager(MessageDispatchInterceptor.class);
      ...
      if ((getCurrentSize() + msg.getMessage().getLength()) > maxQueueSize) {
        if (alwaysSend) {
          ...
          throw new ChannelException(
            sm.getString("messageDispatchInterceptor.queue.full", Long.toString(maxQueueSize),
  ...
  public void startQueue() {
    ...
    executor = ExecutorFactory
      .newThreadPool(maxSpareThreads, maxThreads, keepAliveTime, TimeUnit.MILLISECONDS,
                     new TcclThreadFactory(
                       "MessageDispatchInterceptor.MessageDispatchThread" + channelName));
    run = true;
  }
