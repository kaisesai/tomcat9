...
public class FragmentationInterceptor extends ChannelInterceptorBase
  ...
  protected static final StringManager sm = StringManager
    .getManager(FragmentationInterceptor.class);
  ...
  public void messageReceived(ChannelMessage msg) {
    boolean isFrag = XByteBuffer
      .toBoolean(msg.getMessage().getBytesDirect(), msg.getMessage().getLength() - 1);
  ...
  public static class FragCollection {
    ...
    public FragCollection(ChannelMessage msg) {
      ...
      int count = XByteBuffer
        .toInt(msg.getMessage().getBytesDirect(), msg.getMessage().getLength() - 4);
