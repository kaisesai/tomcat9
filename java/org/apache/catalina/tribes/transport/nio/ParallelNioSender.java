...
public class ParallelNioSender extends AbstractSender implements MultiPointSender {
  ...
  private SendResult doLoop(long selectTimeOut, int maxAttempts, boolean waitForAck,
      ...
      try {
        if (sender.process(sk, waitForAck)) {
          ...
          if (Logs.MESSAGES.isTraceEnabled()) {
            Logs.MESSAGES.trace(
              "ParallelNioSender - Sent msg:" + new UniqueId(msg.getUniqueId()) + " at "
                + new java.sql.Timestamp(System.currentTimeMillis()) + " to " + sender
