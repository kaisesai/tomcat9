...
public class ExecutorFactory {
  ...
  public static ExecutorService newThreadPool(int minThreads, int maxThreads, long maxIdleTime,
    ...
    ThreadPoolExecutor service = new TribesThreadPoolExecutor(minThreads, maxThreads, maxIdleTime,
                                                              unit, taskqueue);
  ...
  private static class TribesThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public TribesThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime,
