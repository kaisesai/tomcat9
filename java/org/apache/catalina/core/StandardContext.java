...
public class StandardContext extends ContainerBase implements Context, NotificationEmitter {
    ...
    public void setSessionCookieDomain(String sessionCookieDomain) {
        ...
        support
          .firePropertyChange("sessionCookieDomain", oldSessionCookieDomain, sessionCookieDomain);
    }
    ...
    public void setIgnoreAnnotations(boolean ignoreAnnotations) {
        ...
        support
          .firePropertyChange("ignoreAnnotations", oldIgnoreAnnotations, this.ignoreAnnotations);
    }
    ...
    public void setCharsetMapperClass(String mapper) {
        ...
        support
          .firePropertyChange("charsetMapperClass", oldCharsetMapperClass, this.charsetMapperClass);
    ...
    public void setClearReferencesStopTimerThreads(boolean clearReferencesStopTimerThreads) {
        ...
        support
          .firePropertyChange("clearReferencesStopTimerThreads", oldClearReferencesStopTimerThreads,
    ...
    public void setRenewThreadsWhenStoppingContext(boolean renewThreadsWhenStoppingContext) {
        ...
        support
          .firePropertyChange("renewThreadsWhenStoppingContext", oldRenewThreadsWhenStoppingContext,
    ...
    public void addApplicationParameter(ApplicationParameter parameter) {
        ...
        synchronized (applicationParametersLock) {
            ...
            ApplicationParameter results[] = Arrays
              .copyOf(applicationParameters, applicationParameters.length + 1);
        ...
        synchronized (wrapperListenersLock) {
            for (String wrapperListener : wrapperListeners) {
                try {
                    ...
                    ExceptionUtils.handleThrowable(t);
                    log.error(sm.getString("standardContext.createWrapper.containerListenerError"),
                              t);
                    return null;
                }
            }
        ...
        if (resources != null) {
            try {
                ...
                if (canonicalPath == null) {
                  ...
                  (resource.isDirectory() && !canonicalPath.endsWith(File.separator) || !resource
    ...
    public boolean filterStart() {
        ...
        synchronized (filterConfigs) {
            ...
            for (Entry<String, FilterDef> entry : filterDefs.entrySet()) {
                ...
                try {
                    ApplicationFilterConfig filterConfig = new ApplicationFilterConfig(this, entry
                      .getValue());
    ...
    public boolean listenerStart() {
        ...
        for (int i = 0; i < results.length; i++) {
            ...
            try {
                ...
                ExceptionUtils.handleThrowable(t);
                getLogger()
                  .error(sm.getString("standardContext.applicationListener", listeners[i]), t);
                ok = false;
            }
        }
        if (!ok) {
        ...
        for (ArrayList<Wrapper> list : map.values()) {
            for (Wrapper wrapper : list) {
                try {
                    ...
                    getLogger().error(
                      sm.getString("standardContext.loadOnStartup.loadException", getName(),
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        try {
                    ...
                    CredentialHandler safeHandler = new CredentialHandler() {
                        ...
                        public boolean matches(String inputCredentials, String storedCredentials) {
                            return getRealmInternal().getCredentialHandler()
                              .matches(inputCredentials, storedCredentials);
                        }
            ...
            if (ok) {
                ...
                getServletContext()
                  .setAttribute(InstanceManager.class.getName(), getInstanceManager());
    ...
    private void checkConstraintsForUncoveredMethods(SecurityConstraint[] constraints) {
        SecurityConstraint[] newConstraints = SecurityConstraint
          .findUncoveredHttpMethods(constraints, getDenyUncoveredHttpMethods(), getLogger());
    ...
    private void setClassLoaderProperty(String name, boolean value) {
        ...
        if (!IntrospectionUtils.setProperty(cl, name, Boolean.toString(value))) {
            // Failed to set
            log.info(sm.getString("standardContext.webappClassLoader.missingProperty", name,
    ...
    public InstanceManager createInstanceManager() {
        ...
        return new DefaultInstanceManager(context, injectionMap, this,
    ...
    private void postWorkDirectory() {
        ...
        if (!dir.isAbsolute()) {
            ...
            try {
                ...
                log.warn(
                  sm.getString("standardContext.workCreateException", workDir, catalinaHomePath,
                               getName()), e);
            }
        }
