...
public abstract class ContainerBase extends LifecycleMBeanBase implements Container {
    ...
    public void setParentClassLoader(ClassLoader parent) {
        ...
        support
          .firePropertyChange("parentClassLoader", oldParentClassLoader, this.parentClassLoader);
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (backgroundProcessorDelay > 0) {
            monitorFuture = Container.getService(ContainerBase.this).getServer()
              .getUtilityExecutor()
              .scheduleWithFixedDelay(new ContainerBackgroundProcessorMonitor(), 0, 60,
                                      TimeUnit.SECONDS);
        }
    }
    ...
    protected void threadStart() {
        if (backgroundProcessorDelay > 0 && (getState().isAvailable()
          || LifecycleState.STARTING_PREP.equals(getState())) && (backgroundProcessorFuture == null
