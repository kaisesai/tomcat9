...
public class NamingContextListener
  ...
  public void propertyChange(PropertyChangeEvent event) {
    ...
    if (source == namingResources) {
      ...
      processGlobalResourcesChange(event.getPropertyName(), event.getOldValue(),
                                   event.getNewValue());
  ...
  protected ObjectName createObjectName(ContextResource resource)
    ...
    if (container instanceof Server) {
      name = new ObjectName(domain + ":type=DataSource" + ",class=" + resource.getType() + ",name="
                              + quotedResourceName);
      ...
      name = new ObjectName(
        domain + ":type=DataSource" + ",host=" + host.getName() + ",context=" + contextName
  ...
  public void addService(ContextService service) {
    ...
    if (ref == null) {
      ...
      while (portcomponent.hasNext()) {
        ...
        StringRefAddr refAddr = new StringRefAddr(ServiceRef.SERVICEENDPOINTINTERFACE,
                                                  serviceendpoint);
        ref.add(refAddr);
  ...
  public void addResource(ContextResource resource) {
    ...
    if (("javax.sql.DataSource".equals(ref.getClassName()) || "javax.sql.XADataSource"
      .equals(ref.getClassName())) && resource.getSingleton()) {
  ...
  public void addResourceLink(ContextResourceLink resourceLink) {
    ...
    ResourceLinkFactory
      .registerGlobalResourceAccess(getGlobalNamingContext(), resourceLink.getName(),
