...
public class Response implements HttpServletResponse {
    ...
    private static boolean doIsEncodeable(Context context, Request hreq, Session session,
        ...
        if (contextPath != null) {
            ...
            String tok = ";" + SessionConfig.getSessionUriParamName(context) + "=" + session
              .getIdInternal();
    ...
    public boolean isAppCommitted() {
        return this.appCommitted || isCommitted() || isSuspended() || ((getContentLength() > 0) && (
    ...
    public void sendRedirect(String location, int status) throws IOException {
        ...
        try {
            ...
            if (getRequest().getCoyoteRequest().getSupportsRelativeRedirects() && getContext()
