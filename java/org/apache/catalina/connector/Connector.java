...
public class Connector extends LifecycleMBeanBase {
    ...
    public Connector(String protocol) {
        boolean apr = AprStatus.isAprAvailable() && AprStatus.getUseAprConnector();
    ...
    public String getProtocol() {
        ...
        if ((!apr && org.apache.coyote.http11.Http11NioProtocol.class.getName()
          .equals(protocolHandlerClassName)) || (apr
          && org.apache.coyote.http11.Http11AprProtocol.class.getName()
          .equals(protocolHandlerClassName))) {
            return "HTTP/1.1";
        } else if ((!apr && org.apache.coyote.ajp.AjpNioProtocol.class.getName()
          .equals(protocolHandlerClassName)) || (apr && org.apache.coyote.ajp.AjpAprProtocol.class
          .getName().equals(protocolHandlerClassName))) {
            return "AJP/1.3";
        }
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
            ...
            throw new LifecycleException(sm.getString("coyoteConnector.protocolHandlerStartFailed"),
                                         e);
        }
    }
    ...
    protected void stopInternal() throws LifecycleException {
        ...
        try {
            ...
            throw new LifecycleException(sm.getString("coyoteConnector.protocolHandlerStopFailed"),
                                         e);
        }
    }
