...
public class MemoryUserDatabaseMBean extends BaseModelMBean {
  ...
  public String createGroup(String groupname, String description) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createMBeanError.group", groupname));
      iae.initCause(e);
      throw iae;
    }
  ...
  public String createRole(String rolename, String description) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createMBeanError.role", rolename));
      iae.initCause(e);
      throw iae;
    }
  ...
  public String createUser(String username, String password, String fullName) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createMBeanError.user", username));
      iae.initCause(e);
      throw iae;
    }
  ...
  public String findGroup(String groupname) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createError.group", groupname));
      iae.initCause(e);
      throw iae;
    }
  }
  ...
  public String findRole(String rolename) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createError.role", rolename));
      iae.initCause(e);
      throw iae;
    }
  ...
  public String findUser(String username) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.createError.user", username));
      iae.initCause(e);
      throw iae;
    }
  }
  ...
  public void removeGroup(String groupname) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.destroyError.group", groupname));
      iae.initCause(e);
      throw iae;
    }
  }
  ...
  public void removeRole(String rolename) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.destroyError.role", rolename));
      iae.initCause(e);
      throw iae;
    }
  }
  ...
  public void removeUser(String username) {
    ...
    try {
      ...
      IllegalArgumentException iae = new IllegalArgumentException(
        sm.getString("userMBean.destroyError.user", username));
      iae.initCause(e);
      throw iae;
    }
  }
