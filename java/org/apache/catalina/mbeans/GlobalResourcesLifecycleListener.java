...
public class GlobalResourcesLifecycleListener implements LifecycleListener {
  ...
  protected static final StringManager sm = StringManager
    .getManager(GlobalResourcesLifecycleListener.class);
  ...
  protected void createMBeans(String name, UserDatabase database) throws Exception {
    ...
    try {
      ...
      throw new IllegalArgumentException(
        sm.getString("globalResources.createError.userDatabase", name), e);
    }
    ...
    while (roles.hasNext()) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
          sm.getString("globalResources.createError.userDatabase.role", role), e);
      }
    }
    ...
    while (users.hasNext()) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
          sm.getString("globalResources.createError.userDatabase.user", user), e);
      }
    }
  }
