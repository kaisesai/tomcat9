...
public class SSLAuthenticator extends AuthenticatorBase {
  ...
  protected boolean doAuthenticate(Request request, HttpServletResponse response)
    ...
    if ((certs == null) || (certs.length < 1)) {
      ...
      response
        .sendError(HttpServletResponse.SC_UNAUTHORIZED, sm.getString("authenticator.certificates"));
      return false;
    }
    ...
    if (principal == null) {
      ...
      response
        .sendError(HttpServletResponse.SC_UNAUTHORIZED, sm.getString("authenticator.unauthorized"));
      return false;
    }
