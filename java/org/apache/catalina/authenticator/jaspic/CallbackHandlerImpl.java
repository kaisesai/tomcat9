    ...
    if (callbacks != null) {
      ...
      for (Callback callback : callbacks) {
        if (callback instanceof CallerPrincipalCallback) {
          ...
          if (container == null) {
            log.warn(
              sm.getString("callbackHandlerImpl.containerMissing", callback.getClass().getName()));
            ...
            principal = container.getRealm()
              .authenticate(pvc.getUsername(), String.valueOf(pvc.getPassword()));
