...
public class StoreRegistry {
  ...
  // Access Information
  private static Class<?> interfaces[] = {CatalinaCluster.class, ChannelSender.class,
    ChannelReceiver.class, Channel.class, MembershipService.class, ClusterDeployer.class,
    Realm.class, Manager.class, DirContext.class, LifecycleListener.class, Valve.class,
    ClusterListener.class, MessageListener.class, DataSender.class, ChannelInterceptor.class,
    Member.class, WebResourceRoot.class, WebResourceSet.class, CredentialHandler.class,
    UpgradeProtocol.class, CookieProcessor.class};
  ...
  public StoreDescription findDescription(String id) {
    ...
    if (log.isDebugEnabled()) {
      if (desc != null) {
        log
          .debug("find descriptor " + id + "#" + desc.getTag() + "#" + desc.getStoreFactoryClass());
      } else {
  ...
  public void registerDescription(StoreDescription desc) {
    ...
    if (log.isDebugEnabled()) {
      log
        .debug("register store descriptor " + key + "#" + desc.getTag() + "#" + desc.getTagClass());
    }
  }
