...
public class JAASRealm extends RealmBase {
  ...
  public Principal authenticate(String username, String clientDigest, String nonce, String nc,
    ...
    return authenticate(username,
                        new JAASCallbackHandler(this, username, clientDigest, nonce, nc, cnonce,
                                                qop, realmName, md5a2,
  ...
  protected Principal getPrincipal(String username) {
    ...
    return authenticate(username,
                        new JAASCallbackHandler(this, username, null, null, null, null, null, null,
  ...
  protected Configuration getConfig() {
    ...
    try {
      ...
      synchronized (this) {
        ...
        @SuppressWarnings("unchecked") Class<Configuration> sunConfigFile
