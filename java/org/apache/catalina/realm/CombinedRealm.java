...
public class CombinedRealm extends RealmBase {
  ...
  public void addRealm(Realm theRealm) {
    ...
    if (log.isDebugEnabled()) {
      sm.getString("combinedRealm.addRealm", theRealm.getClass().getName(),
  ...
  public Principal authenticate(String username, String clientDigest, String nonce, String nc,
                                String cnonce, String qop, String realmName, String md5a2) {
    ...
    for (Realm realm : realms) {
      ...
      authenticatedUser = realm
        .authenticate(username, clientDigest, nonce, nc, cnonce, qop, realmName, md5a2);
      ...
      if (authenticatedUser == null) {
        ...
        if (log.isDebugEnabled()) {
          log
            .debug(sm.getString("combinedRealm.authSuccess", username, realm.getClass().getName()));
        }
        break;
      }
    }
    ...
    if (gssContext.isEstablished()) {
      ...
      for (Realm realm : realms) {
        ...
        if (authenticatedUser == null) {
          ...
          if (log.isDebugEnabled()) {
            log.debug(
              sm.getString("combinedRealm.authSuccess", gssName, realm.getClass().getName()));
          }
          break;
        }
      }
