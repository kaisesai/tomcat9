  ...
  public boolean matches(String inputCredentials, String storedCredentials) {
    ...
    if (getAlgorithm() == null) {
      ...
      if (storedCredentials.startsWith("{MD5}") || storedCredentials.startsWith("{SHA}")) {
        ...
        byte[] userDigest = ConcurrentMessageDigest
          .digest(getAlgorithm(), inputCredentials.getBytes(StandardCharsets.ISO_8859_1));
  ...
  protected String mutate(String inputCredentials, byte[] salt, int iterations) {
    if (algorithm == null) {
      ...
      if (salt == null) {
        ...
        userDigest = ConcurrentMessageDigest
          .digest(algorithm, iterations, salt, inputCredentialbytes);
      }
