...
public class CrawlerSessionManagerValve extends ValveBase {
  ...
  public void invoke(Request request, Response response) throws IOException, ServletException {
    ...
    String clientIdentifier = getClientIdentifier(request.getHost(), request.getContext(),
                                                  clientIp);
    
    if (log.isDebugEnabled()) {
      log.debug(
        request.hashCode() + ": ClientIdentifier=" + clientIdentifier + ", RequestedSessionId="
      ...
      if (sessionId == null) {
        ...
        if (s != null) {
          ...
          s.setAttribute(this.getClass().getName(),
                         new CrawlerHttpSessionBindingListener(clientIdSessionId,
                                                               clientIdentifier));
  ...
  private static class CrawlerHttpSessionBindingListener
    ...
    private CrawlerHttpSessionBindingListener(Map<String, String> clientIdSessionId,
