...
public class EjbFactory extends FactoryBase {
  ...
  protected ObjectFactory getDefaultFactory(Reference ref) throws NamingException {
    ...
    String javaxEjbFactoryClassName = System
      .getProperty("javax.ejb.Factory", Constants.OPENEJB_EJB_FACTORY);
    try {
      factory = (ObjectFactory) Class.forName(javaxEjbFactoryClassName).getConstructor()
        .newInstance();
    } catch (Throwable t) {
