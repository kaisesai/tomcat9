...
public class ServiceProxy implements InvocationHandler {
  ...
  public ServiceProxy(Service service) throws ServiceException {
    ...
    try {
      portQNameClass = Service.class
        .getDeclaredMethod("getPort", new Class[] {QName.class, Class.class});
  ...
  private Object getProxyPortQNameClass(Object[] args) throws ServiceException {
    ...
    for (@SuppressWarnings("unchecked") Iterator<QName> ports = service.getPorts();
         ports.hasNext(); ) {
