    ...
    if (obj instanceof ResourceRef) {
      ...
      try {
        ...
        if (ra != null) {
          ...
          for (String param : value.split(",")) {
            ...
            if (index >= 0) {
              ...
              setterName = "set" + param.substring(0, 1).toUpperCase(Locale.ENGLISH) + param
                .substring(1);
            }
            try {
        ...
        while (e.hasMoreElements()) {
          ...
          if (propName.equals(Constants.FACTORY) || propName.equals("scope") || propName
            .equals("auth") || propName.equals("forceString") || propName.equals("singleton")) {
            continue;
          }
          ...
          if (method != null) {
            ...
            try {
              ...
              throw new NamingException(
                "Forced String setter " + method.getName() + " threw exception for property "
                  + propName);
            }
            continue;
          }
          ...
          for (i = 0; i < pda.length; i++) {
            ...
            if (pda[i].getName().equals(propName)) {
              ...
              if (propType.equals(String.class)) {
                ...
                throw new NamingException(
                  "String conversion for property " + propName + " of type '" + propType.getName()
                    + "' not available");
              }
