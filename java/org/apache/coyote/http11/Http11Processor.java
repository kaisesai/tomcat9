...
public class Http11Processor extends AbstractProcessor {
    ...
    private void checkExpectationAndResponseStatus() {
        if (request.hasExpectation() && !isRequestBodyFullyRead() && (response.getStatus() < 200
          || response.getStatus() > 299)) {
    ...
    private void prepareRequestProtocol() {
        ...
        if (protocolMB.equals(Constants.HTTP_11)) {
            ...
            if (log.isDebugEnabled()) {
                log.debug(
                  sm.getString("http11processor.request.prepare") + " Unsupported HTTP version \""
                    + protocolMB + "\"");
            }
        }
    }
        ...
        if (uriBC.startsWithIgnoreCase("http", 0)) {
            ...
            if (uriBC.startsWith("://", pos)) {
                ...
                if (slashPos == -1) {
                    ...
                    request.requestURI()
                      .setBytes(uriB, uriBCStart + slashPos, uriBC.getLength() - slashPos);
                }
                ...
                if (http11) {
                    ...
                    if (hostValueMB != null) {
                        ...
                        // the Host header
                        if (!hostValueMB.getByteChunk()
                          .equals(uriB, uriBCStart + pos, slashPos - pos)) {
                ...
                if (connectionKeepAlivePresent) {
                    ...
                    if (keepAliveTimeout > 0) {
                        ...
                        if (http11) {
                            ...
                            MessageBytes connectionHeaderValue = headers
                              .getValue(Constants.CONNECTION);
