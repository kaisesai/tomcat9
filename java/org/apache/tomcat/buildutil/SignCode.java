...
public class SignCode extends Task {
  ...
  private static SOAPBody populateEnvelope(SOAPMessage message, String namespace)
    ...
    envelope
      .addNamespaceDeclaration(namespace, "http://api.ws.symantec.com/webtrust/codesigningservice");
    return envelope.getBody();
  }
  
  private static void addCredentials(SOAPElement requestSigningRequest, String user, String pwd,
  ...
  private String makeSigningRequest(List<File> filesToSign) throws SOAPException, IOException {
    ...
    SOAPElement applicationVersion = requestSigningRequest
      .addChildElement("applicationVersion", NS);
    applicationVersion.addTextNode(this.applicationVersion);
    
    SOAPElement signingServiceName = requestSigningRequest
      .addChildElement("signingServiceName", NS);
