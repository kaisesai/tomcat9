...
public class Socket {
   ...
   * @return The number of bytes sent
   */
  public static native int sendto(long sock, long where, int flags, byte[] buf, int offset,
                                  int len);
   ...
   * @return the number of bytes received.
   */
  public static native int recvfrom(long from, long sock, int flags, byte[] buf, int offset,
                                    int nbytes);
   ...
   * file, and trailers
   */
  public static native long sendfile(long sock, long file, byte[][] headers, byte[][] trailers,
