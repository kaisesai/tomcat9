...
public final class SSLContext {
  ...
  public static final byte[] DEFAULT_SESSION_ID_CONTEXT = new byte[] {'d', 'e', 'f', 'a', 'u', 'l',
    't'};
   ...
   * @throws Exception An error occurred
   */
  public static native boolean setCertificate(long ctx, String cert, String key, String password,
   ...
   * @throws Exception An error occurred
   */
  public static native boolean setCACertificate(long ctx, String file, String path)
    throws Exception;
   ...
   */
  public static native void setNpnProtos(long ctx, String[] nextProtos,
   ...
   *                                and {@link SSL#SSL_SELECTOR_FAILURE_CHOOSE_MY_LAST_PROTOCOL}
   */
  public static native void setAlpnProtos(long ctx, String[] alpnProtos,
                                          int selectorFailureBehavior);
