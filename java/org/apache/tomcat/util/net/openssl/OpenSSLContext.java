...
public class OpenSSLContext implements org.apache.tomcat.util.net.SSLContext {
  ...
  public synchronized void init(KeyManager[] kms, TrustManager[] tms, SecureRandom sr) {
    ...
    try {
      ...
      if (tms != null) {
        ...
        SSLContext.setCACertificate(ctx, SSLHostConfig
          .adjustRelativePath(sslHostConfig.getCaCertificateFile()), SSLHostConfig
                                      .adjustRelativePath(sslHostConfig.getCaCertificatePath()));
      }
  ...
  public void addCertificate(SSLHostConfigCertificate certificate) throws Exception {
    ...
    if (certificate.getCertificateFile() != null) {
      // Set certificate
      SSLContext
        .setCertificate(ctx, SSLHostConfig.adjustRelativePath(certificate.getCertificateFile()),
                        SSLHostConfig.adjustRelativePath(certificate.getCertificateKeyFile()),
                        certificate.getCertificateKeyPassword(), getCertificateIndex(certificate));
      // Set certificate chain file
      SSLContext.setCertificateChainFile(ctx, SSLHostConfig
        .adjustRelativePath(certificate.getCertificateChainFile()), false);
      // Set revocation
      SSLContext.setCARevocation(ctx, SSLHostConfig
        .adjustRelativePath(sslHostConfig.getCertificateRevocationListFile()), SSLHostConfig
                                   .adjustRelativePath(
  ...
  public SSLEngine createSSLEngine() {
    return new OpenSSLEngine(ctx, defaultProtocol, false, sessionContext,
                             ...
                             initialized, sslHostConfig.getCertificateVerificationDepth(),
