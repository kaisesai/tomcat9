...
public class SSLHostConfigCertificate implements Serializable {
  ...
  static final String DEFAULT_KEYSTORE_PROVIDER = System
    .getProperty("javax.net.ssl.keyStoreProvider");
  
  static final String DEFAULT_KEYSTORE_TYPE = System
  ...
  private void setStoreType(String name, StoreType type) {
    if (storeType == null) {
      ...
      log.warn(
        sm.getString("sslHostConfigCertificate.mismatch", name, sslHostConfig.getHostName(), type,
                     this.storeType));
    }
  }
  ...
  public enum Type {
    ...
    UNDEFINED, RSA(Authentication.RSA), DSA(Authentication.DSS), EC(Authentication.ECDH,
