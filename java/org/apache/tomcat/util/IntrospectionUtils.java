...
public final class IntrospectionUtils {
  ...
  public static boolean setProperty(Object o, String name, String value, boolean invokeSetProperty,
    ...
    try {
      ...
      for (Method item : methods) {
        ...
        if (setter.equals(item.getName()) && paramT.length == 1 && "java.lang.String"
  ...
  public static Object callMethod1(Object target, String methodN, Object param1, String typeParam1,
    ...
    if (log.isDebugEnabled()) {
      log.debug(
        "IntrospectionUtils: callMethod1 " + target.getClass().getName() + " " + param1.getClass()
          .getName() + " " + typeParam1);
    }
  ...
  public static Object callMethodN(Object target, String methodN, Object params[],
    ...
    if (m == null) {
      if (log.isDebugEnabled()) {
        log.debug(
          "IntrospectionUtils: Can't find method " + methodN + " in " + target + " CLASS " + target
            .getClass());
      }
      return null;
    }
