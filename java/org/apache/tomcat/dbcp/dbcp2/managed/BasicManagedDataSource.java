...
public class BasicManagedDataSource extends BasicDataSource {
  ...
  protected ConnectionFactory createConnectionFactory() throws SQLException {
    ...
    if (xaDataSource == null) {
      ...
      final XAConnectionFactory xaConnectionFactory = new LocalXAConnectionFactory(
        getTransactionManager(), getTransactionSynchronizationRegistry(), connectionFactory);
    ...
    final XAConnectionFactory xaConnectionFactory = new DataSourceXAConnectionFactory(
      getTransactionManager(), xaDataSourceInstance, getUsername(),
