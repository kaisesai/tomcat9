...
public class PerUserPoolDataSource extends InstanceKeyDataSource {
  ...
  private ObjectPool<PooledConnectionAndInfo> getCPDSConnectionFactoryPool(
  ...
  @Override
  protected PooledConnectionAndInfo getPooledConnectionAndInfo(final String userName,
  ...
  private synchronized void registerPool(final String userName, final String password)
    ...
    if (old != null) {
      throw new IllegalStateException(
        "Pool already contains an entry for this user/password: " + userName);
    }
  }
