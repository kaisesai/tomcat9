...
abstract class InstanceKeyDataSourceFactory implements ObjectFactory {
  ...
  public static void closeAll() throws Exception {
    ...
    if (!exceptionList.isEmpty()) {
      throw new ListException("Could not close all InstanceKeyDataSource instances.",
                              exceptionList);
    }
  }
  ...
  private void setCommonProperties(final Reference ref, final InstanceKeyDataSource ikds)
    ...
    if (refAddr != null && refAddr.getContent() != null) {
      ikds.setDefaultBlockWhenExhausted(
        Boolean.valueOf(refAddr.getContent().toString()).booleanValue());
    }
    ...
    if (refAddr != null && refAddr.getContent() != null) {
      ikds
        .setDefaultSoftMinEvictableIdleTimeMillis(Long.parseLong(refAddr.getContent().toString()));
    }
    ...
    if (refAddr != null && refAddr.getContent() != null) {
      ikds.setRollbackAfterValidation(
        Boolean.valueOf(refAddr.getContent().toString()).booleanValue());
    }
