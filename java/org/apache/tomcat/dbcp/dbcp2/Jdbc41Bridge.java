...
public class Jdbc41Bridge {
  ...
  public static <T> T getObject(final ResultSet resultSet, final int columnIndex,
                                final Class<T> type) throws SQLException {
    try {
      ...
      throw new SQLFeatureNotSupportedException(String
                                                  .format("resultSet=%s, columnIndex=%,d, type=%s",
                                                          resultSet, Integer.valueOf(columnIndex),
                                                          type));
    }
  }
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> T getObject(final ResultSet resultSet, final String columnLabel,
                                final Class<T> type) throws SQLException {
    try {
   ...
   */
  public static ResultSet getPseudoColumns(final DatabaseMetaData databaseMetaData,
   ...
   */
  public static void setNetworkTimeout(final Connection connection, final Executor executor,
