...
public class DriverAdapterCPDS
  ...
  public Reference getReference() throws NamingException {
    ...
    ref
      .add(new StringRefAddr("poolPreparedStatements", String.valueOf(isPoolPreparedStatements())));
    ...
    ref.add(
      new StringRefAddr("numTestsPerEvictionRun", String.valueOf(getNumTestsPerEvictionRun())));
