...
class PooledConnectionImpl
  ...
  public void activateObject(final PStmtKey key,
                             final PooledObject<DelegatingPreparedStatement> pooledObject)
    throws Exception {
  ...
  protected void finalize() throws Throwable {
    ...
    if (logicalConnection != null && !logicalConnection.isClosed()) {
      throw new SQLException(
        "PooledConnection was gc'ed, without its last Connection being closed.");
    }
  }
  ...
  public Connection getConnection() throws SQLException {
    ...
    if (logicalConnection != null && !logicalConnection.isClosed()) {
      ...
      // be removed !FIXME!
      throw new SQLException(
        "PooledConnection was reused, without its previous Connection being closed.");
    }
  ...
  public PooledObject<DelegatingPreparedStatement> makeObject(final PStmtKey key) throws Exception {
    ...
    @SuppressWarnings("unchecked") final PoolableCallableStatement pcs
      = new PoolableCallableStatement(statement, key, pStmtPool,
  ...
  CallableStatement prepareCall(final String sql) throws SQLException {
    ...
    try {
      return (CallableStatement) pStmtPool
        .borrowObject(createKey(sql, StatementType.CALLABLE_STATEMENT));
    } catch (final RuntimeException e) {
      throw e;
    } catch (final Exception e) {
  ...
  PreparedStatement prepareStatement(final String sql, final int resultSetType,
    ...
    try {
      return pStmtPool
        .borrowObject(createKey(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
    } catch (final RuntimeException e) {
      throw e;
    } catch (final Exception e) {
      throw new SQLException("Borrow prepareStatement from pool failed", e);
