...
public class DelegatingDatabaseMetaData implements DatabaseMetaData {
  ...
  public ResultSet getAttributes(final String catalog, final String schemaPattern,
    ...
    connection.checkOpen();
    try {
      return DelegatingResultSet.wrapResultSet(connection, databaseMetaData
  ...
  public ResultSet getClientInfoProperties() throws SQLException {
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getClientInfoProperties());
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
  ...
  public ResultSet getCrossReference(final String parentCatalog, final String parentSchema,
    ...
    try {
      return DelegatingResultSet.wrapResultSet(connection, databaseMetaData
        .getCrossReference(parentCatalog, parentSchema, parentTable, foreignCatalog, foreignSchema,
                           foreignTable));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
  ...
  public ResultSet getExportedKeys(final String catalog, final String schema, final String table)
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getExportedKeys(catalog, schema, table));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
  ...
  public ResultSet getImportedKeys(final String catalog, final String schema, final String table)
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getImportedKeys(catalog, schema, table));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
  ...
  public ResultSet getPrimaryKeys(final String catalog, final String schema, final String table)
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getPrimaryKeys(catalog, schema, table));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
  ...
  public ResultSet getPseudoColumns(final String catalog, final String schemaPattern,
    ...
    connection.checkOpen();
    try {
      return DelegatingResultSet.wrapResultSet(connection, Jdbc41Bridge
        .getPseudoColumns(databaseMetaData, catalog, schemaPattern, tableNamePattern,
                          columnNamePattern));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
  ...
  public ResultSet getSchemas(final String catalog, final String schemaPattern)
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getSchemas(catalog, schemaPattern));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
  ...
  public ResultSet getVersionColumns(final String catalog, final String schema, final String table)
    ...
    try {
      return DelegatingResultSet
        .wrapResultSet(connection, databaseMetaData.getVersionColumns(catalog, schema, table));
    } catch (final SQLException e) {
      handleException(e);
      throw new AssertionError();
    }
