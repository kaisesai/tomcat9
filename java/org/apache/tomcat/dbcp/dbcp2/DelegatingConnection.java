...
public class DelegatingConnection<C extends Connection> extends AbandonedTrace
  ...
  private void initializeStatement(final DelegatingStatement ds) throws SQLException {
    if (defaultQueryTimeoutSeconds != null && defaultQueryTimeoutSeconds.intValue() != ds
      .getQueryTimeout()) {
  ...
  public Statement createStatement(final int resultSetType, final int resultSetConcurrency)
    ...
    checkOpen();
    try {
      final DelegatingStatement ds = new DelegatingStatement(this, connection
  ...
  public PreparedStatement prepareStatement(final String sql) throws SQLException {
    checkOpen();
    try {
      final DelegatingPreparedStatement dps = new DelegatingPreparedStatement(this, connection
  ...
  public CallableStatement prepareCall(final String sql) throws SQLException {
    checkOpen();
    try {
      final DelegatingCallableStatement dcs = new DelegatingCallableStatement(this, connection
        .prepareCall(sql));
