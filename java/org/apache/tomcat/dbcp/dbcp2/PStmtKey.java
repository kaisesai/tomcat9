...
public class PStmtKey {
   ...
   */
  @Deprecated
  public PStmtKey(final String sql, final String catalog, final int resultSetType,
  ...
  public PStmtKey(final String sql, final String catalog, final int resultSetType,
    ...
    this(sql, catalog, resultSetType, resultSetConcurrency, resultSetHoldability,
  ...
  public PStmtKey(final String sql, final String catalog, final String schema,
    ...
    this(sql, catalog, schema, resultSetType, resultSetConcurrency, resultSetHoldability,
         StatementType.PREPARED_STATEMENT);
  }
   ...
   */
  public PStmtKey(final String sql, final String catalog, final String schema,
                  final StatementType statementType, final Integer autoGeneratedKeys) {
    this.sql = sql;
    this.catalog = catalog;
    this.schema = schema;
    this.statementType = statementType;
  ...
  private class PreparedStatementWithResultSetConcurrency implements StatementBuilder {
    ...
    public Statement createStatement(final Connection connection) throws SQLException {
      return connection
        .prepareStatement(sql, resultSetType.intValue(), resultSetConcurrency.intValue());
    }
