...
public class OneLineFormatter extends Formatter {
  ...
  public OneLineFormatter() {
    String timeFormat = LogManager.getLogManager()
      .getProperty(OneLineFormatter.class.getName() + ".timeFormat");
    if (timeFormat == null) {
  ...
  public void setTimeFormat(final String timeFormat) {
    ...
    final DateFormatCache globalDateCache = new DateFormatCache(globalCacheSize, cachedTimeFormat,
                                                                null);
