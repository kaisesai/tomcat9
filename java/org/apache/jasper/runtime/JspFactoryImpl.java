...
public class JspFactoryImpl extends JspFactory {
  ...
  public PageContext getPageContext(Servlet servlet, ServletRequest request,
    ...
    if (Constants.IS_SECURITY_ENABLED) {
      PrivilegedGetPageContext dp = new PrivilegedGetPageContext(this, servlet, request, response,
                                                                 errorPageURL, needsSession,
                                                                 bufferSize, autoflush);
      return AccessController.doPrivileged(dp);
    } else {
      return internalGetPageContext(servlet, request, response, errorPageURL, needsSession,
                                    bufferSize, autoflush);
    }
  }
  ...
  private static class PrivilegedGetPageContext implements PrivilegedAction<PageContext> {
    ...
    public PageContext run() {
      return factory
        .internalGetPageContext(servlet, request, response, errorPageURL, needsSession, bufferSize,
                                autoflush);
    }
