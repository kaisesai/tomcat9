...
public class JspRuntimeLibrary {
  ...
  public static Object coerce(String s, Class<?> target) {
    ...
    if (target == Boolean.class) {
      ...
      if (isNullOrEmpty) {
        ...
        @SuppressWarnings("null") Character result = Character.valueOf(s.charAt(0));
        return result;
      }
   ...
   */
  public static void createTypedArray(String propertyName, Object bean, Method method,
                                      String[] values, Class<?> t, Class<?> propertyEditorClass)
    throws JasperException {
    ...
    try {
      if (propertyEditorClass != null) {
        ...
        for (int i = 0; i < values.length; i++) {
          tmpval[i] = getValueFromBeanInfoPropertyEditor(t, propertyName, values[i],
                                                         propertyEditorClass);
        }
  ...
  public static void handleSetPropertyExpression(Object bean, String prop, String expression,
    ...
    try {
      ...
      method.invoke(bean, new Object[] {
        PageContextImpl.proprietaryEvaluate(expression, method.getParameterTypes()[0], pageContext,
                                            functionMapper)});
    } catch (Exception ex) {
      Throwable thr = ExceptionUtils.unwrapInvocationTargetException(ex);
      ExceptionUtils.handleThrowable(thr);
  ...
  public static Object getValueFromBeanInfoPropertyEditor(Class<?> attrClass, String attrName,
                                                          String attrValue,
    ...
    try {
      ...
      if (attrValue.length() == 0) {
        ...
        throw new JasperException(Localizer
                                    .getMessage("jsp.error.beans.property.conversion", attrValue,
                                                attrClass.getName(), attrName, ex.getMessage()));
      }
    }
  }
  
  public static Object getValueFromPropertyEditorManager(Class<?> attrClass, String attrName,
   ...
   */
  public static void include(ServletRequest request, ServletResponse response, String relativePath,
