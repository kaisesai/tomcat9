...
public class AntCompiler extends Compiler {
  ...
  protected void generateClass(Map<String, SmapStratum> smaps)
    ...
    if (log.isDebugEnabled()) {
      log.debug("Using classpath: " + System.getProperty("java.class.path") + File.pathSeparator
                  + classpath);
    }
    ...
    if (be != null) {
      ...
      JavacErrorDetail[] javacErrors = ErrorDispatcher
        .parseJavacErrors(errorReportString, javaFileName, pageNodes);
      if (javacErrors != null) {
