...
class DefaultErrorHandler implements ErrorHandler {
  ...
  public void jspError(String fname, int line, int column, String errMsg, Exception ex)
    ...
    throw new JasperException(fname + " (" + Localizer
      .getMessage("jsp.error.location", Integer.toString(line), Integer.toString(column)) + ") "
                                + errMsg, ex);
  }
  ...
  public void javacError(JavacErrorDetail[] details) throws JasperException {
    ...
    for (JavacErrorDetail detail : details) {
      if (detail.getJspBeginLineNumber() >= 0) {
        args = new Object[] {Integer.valueOf(detail.getJspBeginLineNumber()),
