...
class Generator {
  ...
  private static final String VAR_EXPRESSIONFACTORY = System
    .getProperty("org.apache.jasper.compiler.Generator.VAR_EXPRESSIONFACTORY",
                 "_el_expressionfactory");
  
  private static final String VAR_INSTANCEMANAGER = System
    .getProperty("org.apache.jasper.compiler.Generator.VAR_INSTANCEMANAGER",
  ...
  private static final boolean STRICT_GET_PROPERTY = Boolean.parseBoolean(
    System.getProperty("org.apache.jasper.compiler.Generator.STRICT_GET_PROPERTY", "true"));
  ...
  Generator(ServletWriter out, Compiler compiler) throws JasperException {
    ...
    try {
      elInterpreter = ELInterpreterFactory
        .getELInterpreter(compiler.getCompilationContext().getServletContext());
    } catch (Exception e) {
   ...
   */
  public static void generate(ServletWriter out, Compiler compiler, Node.Nodes page)
    ...
    if (gen.ctxt.isTagFile()) {
      ...
      page.visit(gen.new GenerateVisitor(gen.ctxt.isTagFile(), out, gen.methodsBuffered,
  ...
  private void generateInit() {
    ...
    if (ctxt.isTagFile()) {
      ...
      out.printin(VAR_INSTANCEMANAGER);
      out
        .println(" = org.apache.jasper.runtime.InstanceManagerFactory.getInstanceManager(config);");
    }
  ...
  private void generateXmlProlog(Node.Nodes page) {
    ...
    if ((omitXmlDecl != null && !JspUtil.booleanValue(omitXmlDecl)) || (omitXmlDecl == null && page
      .getRoot().isXmlSyntax() && !pageInfo.hasJspRoot() && !ctxt.isTagFile())) {
      String cType = pageInfo.getContentType();
      String charSet = cType.substring(cType.indexOf("charset=") + 8);
      out
        .printil("out.write(\"<?xml version=\\\"1.0\\\" encoding=\\\"" + charSet + "\\\"?>\\n\");");
    }
   ...
   */
  private void generateTagHandlerPreamble(JasperTagInfo tagInfo, Node.Nodes tag)
    throws JasperException {
  ...
  private void generateSetJspContext(TagInfo tagInfo) {
    ...
    for (TagVariableInfo var : tagVars) {
      if (var.getNameFromAttribute() != null && var.getNameGiven() != null) {
        aliasSeen = true;
        break;
      }
    }
      ...
      try {
        ...
        for (PropertyDescriptor propertyDescriptor : pd) {
          ...
          if (propertyDescriptor.getPropertyEditorClass() != null) {
            propertyEditorMaps
              .put(propertyDescriptor.getName(), propertyDescriptor.getPropertyEditorClass());
          }
        }
  ...
  private static class FragmentHelperClass {
    ...
    public void generatePreamble() {
      ...
      out.println();
      out.printil(
        "public " + className + "( int discriminator, javax.servlet.jsp.JspContext jspContext, "
  ...
  private class GenerateVisitor extends Node.Visitor {
    ...
    private String attributeValue(Node.JspAttribute attr, boolean encode, Class<?> expectedType) {
      ...
      if (attr.isExpression()) {
        ...
        v = elInterpreter
          .interpreterCall(ctxt, this.isTagFile, v, expectedType, attr.getEL().getMapName());
        if (encode) {
    ...
    private void printParams(Node n, String pageParam, boolean literal) throws JasperException {
      ...
      class ParamVisitor extends Node.Visitor {
        ...
        public void visit(Node.ParamAction n) throws JasperException {
          ...
          out.print(separator);
          out.print(" + ");
          out.print("org.apache.jasper.runtime.JspRuntimeLibrary." + "URLEncode(" + quote(
            n.getTextAttribute("name")) + ", request.getCharacterEncoding())");
          out.print("+ \"=\" + ");
    ...
    public void visit(Node.ELExpression n) throws JasperException {
      ...
      if (!pageInfo.isELIgnored() && (n.getEL() != null)) {
        out.printil("out.write(" + elInterpreter
          .interpreterCall(ctxt, this.isTagFile, n.getType() + "{" + n.getText() + "}",
    ...
    public void visit(Node.IncludeAction n) throws JasperException {
      ...
      out.printin(
        "org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, " + pageParam);
    ...
    public void visit(Node.GetProperty n) throws JasperException {
      ...
      if (beanInfo.checkVariable(name)) {
        ...
        out.printil(
          "out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString(" + "(((" + beanName
    ...
    public void visit(Node.SetProperty n) throws JasperException {
      ...
      if ("*".equals(property)) {
        ...
        out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper("
                      + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property
                      + "\", request.getParameter(\"" + param + "\"), " + "request, \"" + param
                      + "\", false);");
        ...
        out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.handleSetPropertyExpression("
                      + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", "
                      + quote(value.getValue()) + ", " + "_jspx_page_context, " + value.getEL()
          .getMapName() + ");");
    ...
    public void visit(Node.UseBean n) throws JasperException {
      ...
      if (klass != null) {
        try {
          ...
          if (!Modifier.isPublic(modifiers) || Modifier.isInterface(modifiers) || Modifier
            .isAbstract(modifiers) || !jreCompat.canAccess(null, constructor)) {
            throw new Exception(
    ...
    public void visit(Node.PlugIn n) throws JasperException {
      ...
      class ParamVisitor extends Node.Visitor {
        ...
        public void visit(Node.ParamAction n) throws JasperException {
          ...
          if (ie) {
            ...
            // out.print( " blah=\"" + ... + "\"" );
            out.printil(
              "out.write( \" " + escape(name) + "=\\\"\" + " + attributeValue(n.getValue(), false,
                                                                              String.class)
                + " + \"\\\"\" );");
          }
      ...
      String s0 = "<object" + makeAttr("classid", ctxt.getOptions().getIeClassId()) + makeAttr(
        "name", name);
      ...
      out.printil("out.write(\"\\n\");");
      s0 = "<EMBED" + makeAttr("type", "application/x-java-" + type + ((jreversion == null) ? "" :
                                                                       ";version=" + jreversion))
        + makeAttr("name", name);
      ...
      s3 = makeAttr("hspace", hspace) + makeAttr("vspace", vspace) + makeAttr("align", align)
        + makeAttr("pluginspage", nspluginurl) + makeAttr("java_code", code) + makeAttr(
        "java_codebase", codebase) + makeAttr("java_archive", archive);
      out.printil("out.write(" + quote(s0) + s1 + s2 + " + " + quote(s3) + ");");
    ...
    private void generateCustomStart(Node.CustomTag n, TagHandlerInfo handlerInfo,
                                     String tagHandlerVar, String tagEvalVar,
                                     String tagPushBodyCountVar) throws JasperException {
    ...
    private String evaluateAttribute(TagHandlerInfo handlerInfo, Node.JspAttribute attr,
                                     Node.CustomTag n, String tagHandlerVar)
      throws JasperException {
      ...
      if (attrValue == null) {
        if (attr.isNamedAttribute()) {
          if (n.checkIfAttributeIsJspFragment(attr.getName())) {
            ...
            attrValue = generateNamedAttributeJspFragment(attr.getNamedAttributeNode(),
                                                          tagHandlerVar);
          } else {
      ...
      if (attr.isExpression()) {
        ...
        // depending on type
        if (attr.isDeferredInput() || ((tai != null) && ValueExpression.class.getName()
        ...
        } else if (attr.isDeferredMethodInput() || ((tai != null) && MethodExpression.class
          .getName().equals(tai.getTypeName()))) {
    ...
    private void generateJspFragment(Node n, String tagHandlerVar) throws JasperException {
      ...
      out.print("new " + fragmentHelperClass.getClassName() + "( " + fragment.getId()
                  + ", _jspx_page_context, " + tagHandlerVar + ", " + pushBodyCountVar + ")");
    }
    ...
    public String generateNamedAttributeValue(Node.NamedAttribute n) throws JasperException {
      ...
      if (body != null) {
        ...
        if (!templateTextOptimization) {
          ...
          visitBody(n);
          out.printil(
            "java.lang.String " + varName + " = " + "((javax.servlet.jsp.tagext.BodyContent)"
              + "out).getString();");
          out.printil("out = _jspx_page_context.popBody();");
        }
      } else {
