...
class Parser implements TagConstants {
  ...
  private static final boolean STRICT_WHITESPACE = Boolean.parseBoolean(
    System.getProperty("org.apache.jasper.compiler.Parser.STRICT_WHITESPACE", "true"));
  ...
  public static Node.Nodes parse(ParserController pc, JspReader reader, Node parent,
                                 boolean isTagFile, boolean directivesOnly, Jar jar, String pageEnc,
                                 String jspConfigPageEnc, boolean isDefaultPageEncoding,
      ...
      if (uri != null) {
        ...
        if (pageInfo.getTaglib(uri) == null) {
          ...
          if (impl == null) {
            ...
            impl = new TagLibraryInfoImpl(ctxt, parserController, pageInfo, prefix, uri,
                                          tldResourcePath, err);
            if (ctxt.getOptions().isCaching()) {
        ...
        if (tagdir != null) {
          ...
          if (pageInfo.getTaglib(urnTagdir) == null) {
            pageInfo.addTaglib(urnTagdir,
                               new ImplicitTagLibraryInfo(ctxt, parserController, pageInfo, prefix,
                                                          tagdir, err));
          }
  ...
  private void parseAttributeDirective(Node parent) throws JasperException {
    Attributes attrs = parseAttributes();
    @SuppressWarnings("unused") Node unused = new Node.AttributeDirective(attrs, start, parent);
  }
  ...
  private void parseVariableDirective(Node parent) throws JasperException {
    Attributes attrs = parseAttributes();
    @SuppressWarnings("unused") Node unused = new Node.VariableDirective(attrs, start, parent);
  }
  ...
  private void parseComment(Node parent) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.Comment(reader.getText(start, stop), start,
                                                               parent);
  }
  ...
  private void parseDeclaration(Node parent) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.Declaration(
  ...
  private void parseXMLDeclaration(Node parent) throws JasperException {
    ...
    if (!reader.matches("/>")) {
      ...
      while (true) {
        ...
        @SuppressWarnings("unused") Node unused = new Node.Declaration(text, start, parent);
        if (reader.matches("![CDATA[")) {
          ...
          text = parseScriptText(reader.getText(start, stop));
          @SuppressWarnings("unused") Node unused2 = new Node.Declaration(text, start, parent);
        } else {
          break;
        }
      }
  ...
  private void parseExpression(Node parent) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.Expression(
      parseScriptText(reader.getText(start, stop)), start, parent);
  }
  ...
  private void parseXMLExpression(Node parent) throws JasperException {
    ...
    if (!reader.matches("/>")) {
      ...
      while (true) {
        ...
        text = parseScriptText(reader.getText(start, stop));
        @SuppressWarnings("unused") Node unused = new Node.Expression(text, start, parent);
        if (reader.matches("![CDATA[")) {
          start = reader.mark();
          stop = reader.skipUntil("]]>");
          if (stop == null) {
          ...
          text = parseScriptText(reader.getText(start, stop));
          @SuppressWarnings("unused") Node unused2 = new Node.Expression(text, start, parent);
        } else {
          break;
        }
      }
  ...
  private void parseELExpression(Node parent, char type) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.ELExpression(type,
                                                                    reader.getText(start, last),
                                                                    start, parent);
  }
  ...
  private void parseScriptlet(Node parent) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.Scriptlet(
      parseScriptText(reader.getText(start, stop)), start, parent);
  }
  ...
  private void parseXMLScriptlet(Node parent) throws JasperException {
    ...
    if (!reader.matches("/>")) {
      ...
      while (true) {
        ...
        text = parseScriptText(reader.getText(start, stop));
        @SuppressWarnings("unused") Node unused = new Node.Scriptlet(text, start, parent);
        if (reader.matches("![CDATA[")) {
          start = reader.mark();
          stop = reader.skipUntil("]]>");
          if (stop == null) {
          ...
          text = parseScriptText(reader.getText(start, stop));
          @SuppressWarnings("unused") Node unused2 = new Node.Scriptlet(text, start, parent);
        } else {
          break;
        }
      }
   ...
   */
  private boolean parseJspAttributeAndBody(Node parent, String tag, String bodyType)
    throws JasperException {
  ...
  private boolean parseCustomTag(Node parent) throws JasperException {
    ...
    Node tagNode = null;
    if (tagInfo != null) {
      tagNode = new Node.CustomTag(tagName, prefix, shortTagName, uri, attrs, start, parent,
                                   tagInfo, tagHandlerClass);
    } else {
      tagNode = new Node.CustomTag(tagName, prefix, shortTagName, uri, attrs, start, parent,
                                   tagFileInfo);
  ...
  private void parseTemplateText(Node parent) {
    ...
    @SuppressWarnings("unused") Node unused = new Node.TemplateText(ttext.toString(), start,
                                                                    parent);
  }
  ...
  private void parseElements(Node parent) throws JasperException {
    ...
    } else if (!pageInfo.isELIgnored() && !pageInfo.isDeferredSyntaxAllowedAsLiteral() && reader
      .matches("#{")) {
      parseELExpression(parent, '#');
  ...
  private void parseTagDependentBody(Node parent, String tag) throws JasperException {
    ...
    @SuppressWarnings("unused") Node unused = new Node.TemplateText(
      reader.getText(bodyStart, bodyEnd), bodyStart, parent);
  }
  ...
  private void parseBody(Node parent, String tag, String bodyType) throws JasperException {
    ...
    } else if (bodyType.equalsIgnoreCase(TagInfo.BODY_CONTENT_JSP) || bodyType
      .equalsIgnoreCase(TagInfo.BODY_CONTENT_SCRIPTLESS) || (bodyType == JAVAX_BODY_CONTENT_PARAM)
