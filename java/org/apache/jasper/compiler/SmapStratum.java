...
*/
    ...
    while (i < lineData.size() - 1) {
      ...
      if (!liNext.lineFileIDSet && liNext.inputStartLine == li.inputStartLine
        && liNext.inputLineCount == 1 && li.inputLineCount == 1 && liNext.outputStartLine
    ...
    while (i < lineData.size() - 1) {
      ...
      if (!liNext.lineFileIDSet && liNext.inputStartLine == li.inputStartLine + li.inputLineCount
        && liNext.outputLineIncrement == li.outputLineIncrement && liNext.outputStartLine
        == li.outputStartLine + li.inputLineCount * li.outputLineIncrement) {
   ...
   */
  public void addLineData(int inputStartLine, String inputFileName, int inputLineCount,
  ...
  static class LineInfo {
    ...
    public void setOutputLineIncrement(int outputLineIncrement) {
      if (outputLineIncrement < 0) {
        throw new IllegalArgumentException(Localizer.getMessage("jsp.error.negativeParameter",
                                                                Integer
                                                                  .valueOf(outputLineIncrement)));
      }
