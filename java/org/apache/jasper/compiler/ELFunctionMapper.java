...
public class ELFunctionMapper {
  ...
  public static void map(Node.Nodes page) throws JasperException {
    ...
    if (ds.length() > 0) {
      ...
      @SuppressWarnings("unused") Node unused = new Node.Declaration(map.ss.toString(), null, root);
  ...
  private class ELFunctionVisitor extends Node.Visitor {
    ...
    private void doMap(ELNode.Nodes el) throws JasperException {
      ...
      decName = getMapName();
      ss.append(
        "private static org.apache.jasper.runtime.ProtectedFunctionMapper " + decName + ";\n");
