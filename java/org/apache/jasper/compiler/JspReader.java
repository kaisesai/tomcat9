...
class JspReader {
   ...
   */
  public JspReader(JspCompilationContext ctxt, String fname, String encoding, Jar jar,
   ...
   */
  public JspReader(JspCompilationContext ctxt, String fname, InputStreamReader reader,
