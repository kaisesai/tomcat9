...
public interface ServerEndpointConfig extends EndpointConfig {
  ...
  public final class Builder {
    ...
    public ServerEndpointConfig build() {
      return new DefaultServerEndpointConfig(endpointClass, path, subprotocols, extensions,
                                             encoders, decoders, configurator);
    }
  ...
  public class Configurator {
    ...
    private static Configurator loadDefault() {
      ...
      if (result == null) {
        try {
          @SuppressWarnings("unchecked") Class<Configurator> clazz = (Class<Configurator>) Class
