  ...
  public Object getValue(ELContext context, Object base, Object property) {
    ...
    if (base instanceof ELClass && property instanceof String) {
      ...
      try {
        ...
        if (Modifier.isStatic(modifiers) && Modifier.isPublic(modifiers) && jreCompat
          .canAccess(null, field)) {
    ...
    if (base instanceof ELClass && method instanceof String) {
      ...
      if ("<init>".equals(methodName)) {
        ...
        Object[] parameters = Util
          .buildParameters(match.getParameterTypes(), match.isVarArgs(), params);
        ...
        if (match == null || !Modifier.isStatic(match.getModifiers())) {
          throw new MethodNotFoundException(Util.message(context,
                                                         "staticFieldELResolver.methodNotFound",
