...
class Util {
   ...
   */
  static Method findMethod(Class<?> clazz, Object base, String methodName, Class<?>[] paramTypes,
                           Object[] paramValues) {
  ...
  private static <T> Wrapper<T> findWrapper(Class<?> clazz, List<Wrapper<T>> wrappers, String name,
  ...
  static Method getMethod(Class<?> type, Object base, Method m) {
    ...
    if (m == null || (Modifier.isPublic(type.getModifiers()) && (jreCompat.canAccess(base, m)
      || base != null && jreCompat.canAccess(null, m)))) {
      return m;
    }
